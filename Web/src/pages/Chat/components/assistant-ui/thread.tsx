import { ActionBarPrimitive, MessagePrimitive, ThreadPrimitive, BranchPickerPrimitive, AttachmentPrimitive, ComposerPrimitive } from "@assistant-ui/react";
...
export const Thread: FC = () => {
    return (
        <ThreadPrimitive.Root className="box-border flex h-full w-full flex-col overflow-hidden bg-background"
            style={{
